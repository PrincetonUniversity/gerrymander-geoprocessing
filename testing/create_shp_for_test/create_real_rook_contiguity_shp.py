...
df_small_border.at[0, 'geometry'] = box(0, 0, 1, 1)

df_small_border.at[1, 'name'] = 'bottom_right'
df_small_border.at[1, 'geometry'] = box(1, 0, 2, 1)

df_small_border.at[2, 'name'] = 'top_left'
df_small_border.at[2, 'geometry'] = box(0, 1, 1 + epsilon, 2)

df_small_border.at[3, 'name'] = 'top_right'
df_small_border.at[3, 'geometry'] = box(1 + epsilon, 1, 2, 2)
